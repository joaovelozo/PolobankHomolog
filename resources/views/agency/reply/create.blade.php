          ...
          <div class="row page-title">
              <div class="col-md-12">
                  <nav aria-label="breadcrumb" class="float-right mt-1">
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{url('agency/dashboard')}}">Polocal Bank</a></li>
                          <li class="breadcrumb-item"><a href="{{route('agencyreply.index')}}">Voltar</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('agencyreply.store', $ticket->id) }}">
                            @csrf
