                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-xl-4 align-self-center">
                            <h4 class="mb-1 mt-0">Pix Copia e Cola</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{ route('agency.payment.pix.store') }}">
                                @csrf
                                <div class="form-group">
                                    <input type="text" name="codigo_pix" required class="form-control" placeholder="Cole o codigo PIX">
                                </div>
