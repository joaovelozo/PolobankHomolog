...
<head>
    ...
    <script src="{{ asset('assets/backend/js/maskmoney.min.js') }}" type="text/javascript"></script>
    ...
    <!-- Toastr JS (antes do fechamento do body) -->
...
<body>
    ...
    <!-- Datatables init -->
    <script src="{{ asset('assets/backend/js/pages/datatables.init.js') }}?v={{ time() }}"></script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Verifica se o usuário já compartilhou a localização na sessão atual
            if (!sessionStorage.getItem('locationSent')) {
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        // Envia a latitude e longitude para o Laravel via AJAX
