            ...
            <div class="row page-title align-items-center">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xl-4 align-self-center">
                        <h4 class="mb-1 mt-0">Serviços</h4>
                    </div>
                </div>
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{route('service.create')}}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                            <i class="uil-plus mr-1"></i>Cadastrar Serviço
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('images/' . $item->image) }}" alt="Miniatura" style="max-width: 50px;">
                                            @else
                                                Sem imagem
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm  mr-1" href="{{ route('service.show',$item->id) }}"><i data-feather="eye"></i></a>
                                            <a class="btn btn-primary btn-sm  mr-1" href="{{ route('service.edit',$item->id) }}"><i data-feather="edit"></i></a>
                                        </div>
                                        </td>
