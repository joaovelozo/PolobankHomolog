                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ticketsadmin.update', $ticket->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control" id="response" name="response" aria-describedby="emailHelp" placeholder="Digite Corretamente" >@if($ticket->reply){{ $ticket->reply->response }}@endif</textarea>
                            </div>
                            <div class="form-group">
