                        ...
                        <form method="POST" action="{{route('contracts.store')}}">
                          @csrf
                            ...
                            <div class="form-group">
                              ...
                              <textarea rows="5" class="form-control" id="content" name="content" aria-describedby="emailHelp" placeholder="Digite Corretamente"></textarea>

                          </div>

                          <div class="form-group">
                            <h4 class="font-size-15 mt-3">Contrato de Abertura de Conta?</h4>
                            <div class="">
                                <div class="custom-control custom-radio mb-2">
                                    <input type="radio" id="customRadio1" name="options" value="yes" class="custom-control-input">
                          ...
                          <div class="text-right"> <!-- Adicione esta classe para alinhar à direita -->
                            <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Gerar Contrato</button>
                      </div>
