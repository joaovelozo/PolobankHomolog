    ...
    <div class="content-page">
        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="card">
                    <div class="card-body p-0">
                        <h5 class="card-title header-title border-bottom p-3 mb-0">Saldos</h5>
                        <!-- stat 1 -->
                        <div class="media px-3 py-4 border-bottom">
                            <div class="media-body">
                                ...
                                <span class="text-muted">Total Geral da Contas</span>
                            </div>
                        ...
                        <div class="media px-3 py-4 border-bottom">
                            <div class="media-body">
                                <h4 class="mt-0 mb-1 font-size-22 font-weight-normal"> R$ {{ number_format($totalTransactions, 2, ',', '.') }}</h4>
                                <span class="text-muted">Total Geral de Transações</span>
                            </div>
        ...
        <div class="row">
            <div class="col-xl-5">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mt-0 mb-0 header-title">Últimas Transações</h5>
