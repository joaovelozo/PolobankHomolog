      ...
      <div class="container-fluid">
          <div class="row page-title">
              <div class="col-md-12">
                  ...
                  <h4 class="mb-1 mt-0">Cadastro de Tipos de Transações</h4>
              </div>
          </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('types.store')}}">
                          ...
                          <div class="text-right"> <!-- Adicione esta classe para alinhar à direita -->
                            <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Cadastrar Tipo</button>
                      </div>
                        </form>
