            ...
            <div class="row page-title align-items-center">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xl-4 align-self-center">
                        <h4 class="mb-1 mt-0">Telemedicina</h4>
                    </div>
                </div>
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{route('ateledicine.create')}}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('ateledicine.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm" href="{{ route('ateledicine.show',$item->id) }}"><i data-feather="eye"></i></a>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{ route('ateledicine.edit',$item->id) }}"><i data-feather="edit"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
