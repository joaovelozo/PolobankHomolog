        ...
        <div class="container-fluid">
            <div class="row page-title align-items-center">
                ...
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{route('add.roles.permission')}}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mt-0 mb-1">Permissões</h4>
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-sm" href="{{route('admin.delete.roles',$item->id) }}"><i data-feather="trash"></i></a>
                                                <a class="btn btn-primary btn-sm" href="{{route('admin.edit.roles', $item->id)}}"><i data-feather="edit"></i></a>
                                            </td>
                                        </td>
