                    ...
                    <br>
                      ...
                      <div class="row">
                        ...
                        <div class="col-9">
                            ...
                            <!--- Get User Permissions name !--->



                               @foreach($permissions as $item)
                            <div class="custom-control custom-checkbox">
                                <input class="form-check-input" name="permission[]" {{$role->hasPermissionTo($item->name) ? 'checked' : ''}} type="checkbox" value="{{$item->id}}" id="flexCheckDefault{{$item->id}}">
