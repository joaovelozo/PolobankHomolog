                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @endif
                                            <form method="POST" action="{{route('admininvestment.store')}}">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="performance" name="performance" aria-describedby="emailHelp" placeholder="Digite Corretamente">

                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><b>Taxa de Administração %</b> </label>
                                                    <input type="text" class="form-control" id="tax" name="tax" aria-describedby="emailHelp" placeholder="Digite Corretamente">

                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><b>Prazo Mínimo</b> </label>
                                                    <input type="text" class="form-control" id="term" name="term" aria-describedby="emailHelp" placeholder="Digite Corretamente">
                                                ...
                                                <div class="text-right"> <!-- Adicione esta classe para alinhar à direita -->
                                                    <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Criar Investimento</button>
                                                </div>
