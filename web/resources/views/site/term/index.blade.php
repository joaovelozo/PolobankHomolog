...
<body>
    <div class="">
        ...
        <section>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container">
                    <a class="navbar-brand me-6" href="{{ url('/') }}">
                        <img class="img-fluid" src="{{asset('assets/logo.svg')}}"
                            alt=""></a>
            ...
            <div class="d-none navbar-menu position-fixed top-0 start-0 bottom-0 w-75 mw-xs" style="z-index: 9999;">
                ...
                <nav
                    ...
                    <div class="d-flex align-items-center">
                        <a class="me-auto h4 mb-0 text-decoration-none" href="#"><img class="img-fluid"
                                src="flaro-assets/logos/flaro-logo-black.svg" alt=""></a><a class="navbar-close"
                            href="#">
        ...
        <section class="py-12 py-sm-24 py-md-32">
            <div class="container">
                <div class="row align-items-center mw-6xl mx-auto">
                    <div class="col-12 col-md-5 col-lg-6 mb-16 mb-md-0">
                        <div class="position-relative mw-md mx-auto">
                            <div
                                class="position-absolute bottom-0 start-0 w-100 px-12 pb-12 d-flex justify-content-center">
    ...
    <hr>
    <p class="text-center"><b>O Polocal Bank é um "Correspondente Bancário" STARK SeD S.A, que é registrada
            no BACEN sob o número - <a
    ...
    <div class="position-relative row justify-content-between align-items-center">
        <div class="col-auto"><a class="d-inline-block" href="#"><img src="images/logo-png-1722002115167.webp"
                    alt=""></a></div>
        <div class="col-auto">
            <div class="d-flex align-items-center">
