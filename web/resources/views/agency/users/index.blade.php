                ...
                <div class="row page-title align-items-center">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-xl-4 align-self-center">
                            <h4 class="mb-1 mt-0">Gerentes</h4>
                        </div>
                    </div>
                    <div class="col-md-9 col-xl-6 text-md-right">
                        <div class="mt-4 mt-md-0">
                            <a href="{{ route('manager.create') }}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                                <i class="uil-plus mr-1"></i>Cadastrar Gerente
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0 mb-1">Gestão de Gerentes</h4>
