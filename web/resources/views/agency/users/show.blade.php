        ...
        <div class="container-fluid">
            <div class="row page-title align-items-center">
                <div class="col-md-3 col-xl-6">
                    <p> <img src="{{ asset('assets/backend/icon.png') }}" class="img-fluid" alt="Logo" width="30px"></p>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4"><p>CPF:</p><strong>{{$manager->document}}</strong></p>
                            ...
                            <p class="text-muted mb-4"><p>Número:</p><strong>{{$manager->number}}</strong></p>
                            <p class="text-muted mb-4"><p>Cidade:</p><strong>{{$manager->city}}</strong></p>
                            <p class="text-muted mb-4"><p>CEP:</p><strong>{{$manager->zipcode}}</strong></p>
