            ...
            <div class="row page-title align-items-center">
                ...
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{ route('agencycomunication.index') }}" class="btn btn-secondary">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="badge badge-success float-right">{{$com->title}}</div>
                            <p class="text-success text-uppercase font-size-12 mb-2">Título</p>
                            <p>Descrição:</p><h5><a href="#" class="text-dark">{!!$com->description!!}</a></h5>
                            @if ($com->url)
                            <p>Link:</p>
                            <h5>
                                <a href="{{$com->url}}" class="btn btn-primary" target="_blank">Abrir Link</a>
                            </h5>
                        @endif
