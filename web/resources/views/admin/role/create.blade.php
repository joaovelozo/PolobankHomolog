                        ...
                        <form method="POST" action="{{route('role.store')}}">
                          @csrf
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nome da Permissão de Acesso</label>
                            ...
                            <div class="text-right"> <!-- Adicione esta classe para alinhar à direita -->
                                <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Cadastrar Acesso</button>
                          </div>
                        </form>
