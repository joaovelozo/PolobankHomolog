                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <!-- Início da célula para os botões -->
                                            <a class="btn btn-primary btn-md" href="{{ route('ticketsadmin.show',$item->id) }}"><i class="fa-solid fa-eye"></i></a>
                                            <a class="btn btn-primary btn-md" href="{{ route('ticketsadmin.create',$item->id) }}"><i class="fa-regular fa-comment-dots"></i></a>
                                            <form action="{{ route('ticketsadmin.destroy', $item->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-md" onclick="return confirm('Tem certeza que deseja excluir este ticket?')">
