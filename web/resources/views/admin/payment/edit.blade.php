        ...
        <div class="container-fluid">
            <div class="row page-title">
                <div class="col-md-12">
                    ...
                    <h4 class="mb-1 mt-0">Edição de Pagamentos</h4>
                </div>
            </div>
            <!-- Mensagens de Erro -->
            @if ($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('adpayment.update',$pay->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="title">Título</label>
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $pay->title }}" placeholder="Digite Corretamente" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="amount">Valor da Transferência</label>
                                        <input type="text" class="form-control price" id="amount" name="amount" placeholder="Digite Corretamente" value="{{ $pay->amount }}" required>
                                    </div>
                                    ...
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Editar Pagamento</button>
                                    </div>
                                </form>
...
<script>
    $(document).ready(function() {
        $('#user_id').select2({
            ...
            allowClear: true // Permite limpar a seleção, se desejado
        });
    });
</script>
@endsection
