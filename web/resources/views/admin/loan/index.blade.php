        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mt-0 mb-1">Gestão de Empréstimo</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('loan.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm mr-2"><i data-feather="trash"></i></button>
                                            </form>
                                            <a class="btn btn-info btn-sm mr-2" href="{{ route('loan.show',$item->id) }}"><i data-feather="eye"></i></a>

                                            <a class="btn btn-primary btn-sm mr-2" href="{{ route('loan.edit',$item->id) }}"><i data-feather="edit"></i></a>
                                            </div>
                                        </td>
