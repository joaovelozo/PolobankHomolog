                ...
                <div class="row page-title align-items-center">
                    ...
                    <div class="col-md-9 col-xl-6 text-md-right">
                        <div class="mt-4 mt-md-0">
                            <a href="{{ route('contracts.create') }}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                                <i class="uil-plus mr-1"></i>Criar Contrato
                            </a>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <!-- Início da célula para os botões -->
                                                        <div style="display: flex; align-items: flex-start;">
                                                            <form action="{{ route('contracts.destroy', $item->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <a class="btn btn-info btn-sm mr-1"
                                                                href="{{ route('contracts.show', $item->id) }}"><i
                                                                    data-feather="eye"></i></a>
                                                            <a class="btn btn-primary btn-sm mr-1"
                                                                href="{{ route('contracts.edit', $item->id) }}"><i
