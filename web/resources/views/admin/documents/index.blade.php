            ...
            <div class="row page-title align-items-center">
                ...
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{route('docs.create')}}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                            <i class="uil-plus mr-1"></i>Criar Documento
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('docs.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
