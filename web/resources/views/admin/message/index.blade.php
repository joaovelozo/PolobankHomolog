            ...
            <div class="row page-title align-items-center">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xl-4 align-self-center">
                        <h4 class="mb-1 mt-0">Comunicação</h4>
                    </div>
                </div>
                <div class="col-md-9 col-xl-6 text-md-right">
                    <div class="mt-4 mt-md-0">
                        <a href="{{route('message.create')}}" class="btn btn-custom btn-sm mr-4 mb-3 mb-sm-0">
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <div style="display: flex; align-items: flex-start;">    <form action="{{ route('message.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm mr-1"><i data-feather="trash"></i></button>
                                            </form>
                                            <a class="btn btn-info btn-sm  mr-1" href="{{ route('message.show',$item->id) }}"><i data-feather="eye"></i></a>
                                            <a class="btn btn-primary btn-sm  mr-1" href="{{ route('message.edit',$item->id) }}"><i data-feather="edit"></i></a>
                                        </div>
                                        </td>
