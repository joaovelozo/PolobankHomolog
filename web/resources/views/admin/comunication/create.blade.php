            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('agencycom.store')}}">
                          @csrf
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="url" name="url" aria-describedby="emailHelp" placeholder="Digite Corretamente">

                          </div>


                          <div class="text-right"> <!-- Adicione esta classe para alinhar à direita -->
                            <button type="submit" class="btn btn-primary" style="background-color: #00b81f; color: white;">Cadastrar Mensagem</button>
                      </div>
                        </form>
