            ...
            <div class="container-fluid">
                <div class="row page-title">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-1 mt-0">Cadastro de Planos</h4>
                    </div>
                </div>
                @if ($errors->any())
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('plans.update', $pls->id) }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title"
                                                ...
                                                placeholder="Digite Corretamente" value="{{$pls->title}}">

                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Descrição</label>
                                            <textarea rows="5" class="form-control" id="description" name="description" aria-describedby="emailHelp"
                                                placeholder="Digite Corretamente">{{$pls->description}}</textarea>
                                        </div>


                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><b>Vantagens</b></label>
                                            <input type="text" class="form-control" id="advantages" name="advantages"
                                                placeholder="Adicione as vantagens"
                                                value="{{ old('advantages', implode(',', array_column(json_decode($pls->advantages, true), 'value'))) }}"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="period"
                                                ...
                                                placeholder="Digite Corretamente" value="{{$pls->period}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="amount"
                                                    ...
                                                    placeholder="Digite Corretamente" value="{{$pls->amount}}">
