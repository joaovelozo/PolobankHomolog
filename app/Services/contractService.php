...
class ContractService
        ...
        public function createContractForUser(User $user)
    {
        ...
        try {
            // Gera o conteúdo do contrato automaticamente
            $contractContent = $this->generateContractContent($user);
    ...
    /**
     * Gera o conteúdo HTML do contrato para o usuário especificado.
     */
